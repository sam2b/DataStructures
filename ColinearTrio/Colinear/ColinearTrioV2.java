...
public class ColinearTrioV2 {
	...
	public static void main(String[] args) {
		String[] blah = {"random"};
		Point[] testPoints = (args.length == 0) ? getTestPoints(blah) : getTestPoints(args);
	...
	private static Point[] getTestPoints(final String[] args) {
		Point[] testPoints = null;
		
		final int quantity = (args.length < 2) 
						   ? 2000 
