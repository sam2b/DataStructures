...
/**
 * JUnit test of LinkedListSorted.  THIS IS A COPY OF THE LINKED ARRAY LIST SORTED TEST SUITE.
...
/*	@Test(expected = IllegalArgumentException.class)
	public final void negativeCapacity() {
		laList = new LinkedListSorted<String>(-1);
	}
*/
	/**
	...
	public final void defaultConstructor() {
		laList = new LinkedListSorted<String>();
	...
	public final void set1() {
		final String testData = "bbb";
		
		laList.insert("aaa");
		laList.set(0, testData);
		assertEquals("set 1 fail", "[" + testData + "]", laList.toString());
	}
