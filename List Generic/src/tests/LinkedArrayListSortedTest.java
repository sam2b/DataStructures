...
import mylistpackage.LinkedArrayListSorted;
import mylistpackage.MyIterator;
import mylistpackage.MyList;

/**
 * JUnit test of LinkedArrayListSorted
 * @author Sam Brendel, Kaiyaun Shi, Monika
 * @version 4.16B
 */
public class LinkedArrayListSortedTest {
	...
	public final void negativeCapacity() {
		laList = new LinkedArrayListSorted<String>(-1);
	}
	...
	public final void defaultConstructor() {
		laList = new LinkedArrayListSorted<String>();
	...
	public final void setup() {
		// al = new LinkedArrayListSorted<String>();
		laList = new LinkedArrayListSorted<String>(1);
	}
	...
	public final void zeroCapacity() {
		laList = new LinkedArrayListSorted<String>(0);
	}
